Owl.Extend(Owl.Easing,{
    ...
    inOutElastic:function(a,b,c,d){
        ...
        if(a<1){
            return -0.5*g*Math.pow(2,10*(a-=1))*Math.sin((a*d-e)*2*Math.PI/f)+b;
        }
        return g*Math.pow(2,-10*(a-=1))*Math.sin((a*d-e)*2*Math.PI/f)*0.5+c+b;
    },
    ...
    inOutBack:function(a,b,c,d,e){
        ...
        if((a/=d/2)<1){
            return c/2*a*a*(((e*=1.525)+1)*a-e)+b;
        }
    ...
    outBounce:function(a,b,c,d){
        if((a/=d)<1/2.75){
            ...
            if(a<2/2.75){
                return c*(7.5625*(a-=1.5/2.75)*a+0.75)+b;
            }else{
                if(a<2.5/2.75){
                    return c*(7.5625*(a-=2.25/2.75)*a+0.9375)+b;
                }else{
                    return c*(7.5625*(a-=2.625/2.75)*a+0.984375)+b;
                }
            }
        }
},
inOutBounce:function(a,b,c,d){
    if(a<d/2){
        return Owl.Easing.inBounce(a*2,0,c,d)*0.5+b;
    }
    return Owl.Easing.outBounce(a*2-d,0,c,d)*0.5+c*0.5+b;
}
});