...
$baseUrl = $_SESSION['BASE_URL'] . '/files/news/editor/';
$_SESSION["ckfinder_baseUrl"] = $baseUrl;
/*
  ...
  ATTENTION: The trailing slash is required.
 */
$baseDir = resolveUrl($_SESSION['BASE_DIR'] . '/files/news/editor/'); //resolveUrl($baseUrl);
$_SESSION["ckfinder_baseDir"] = $baseDir;
/*
 * ### Advanced Settings
 */
